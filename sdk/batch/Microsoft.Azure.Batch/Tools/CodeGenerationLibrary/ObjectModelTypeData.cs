...
﻿namespace CodeGenerationLibrary
{
    ...
    public class ObjectModelTypeData
    {
        ...
        /// This is necessary if there is no custom constructor, if the custom constructor isn't at least protected, or if the custom constructor has properties.
        /// </summary>
        public bool ShouldDefineMockableConstructor => HideMockableConstructor == false &&
            (ShouldDefineCustomConstructor == false || ConstructorAccess < AccessModifier.@protected || ConstructorProperties.Any());
